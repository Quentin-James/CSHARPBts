...
public partial class QjamesContext : DbContext
{
    public QjamesContext()
    {
    }

    public QjamesContext(DbContextOptions<QjamesContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=172.16.124.77;Initial Catalog=qjames;User ID=qjames;Password=BTSSN2##;Encrypt=True;Trust Server Certificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
            ...
            entity.HasMany(d => d.Spectacles).WithMany(p => p.Artistes)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        ...
                        j.HasIndex(new[] { "SpectacleId" }, "IX_ArtistesSpectacles_SpectacleID");
        ...
        modelBuilder.Entity<Billet>(entity =>
        {
            ...
            entity.HasIndex(e => e.ProgrammationId, "IX_Billets_ProgrammationID");

            entity.HasIndex(e => e.TarifId, "IX_Billets_TarifID");
            ...
            entity.HasMany(d => d.Spectacles).WithMany(p => p.Groupes)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        ...
                        j.HasIndex(new[] { "SpectacleId" }, "IX_SpectaclesGroupes_SpectacleID");
        ...
        modelBuilder.Entity<Programmation>(entity =>
        {
            ...
            entity.HasIndex(e => e.SpectacleId, "IX_Programmation_SpectacleID");
        ...
        modelBuilder.Entity<Spectacle>(entity =>
        {
            ...
            entity.HasIndex(e => e.SpectacleEnfant1Id, "IX_Spectacles_SpectacleEnfant1Id");

            entity.HasIndex(e => e.SpectacleEnfant2Id, "IX_Spectacles_SpectacleEnfant2Id");

            entity.HasIndex(e => e.SpectacleEnfant3Id, "IX_Spectacles_SpectacleEnfant3Id");

            entity.Property(e => e.SpectacleId).HasColumnName("SpectacleID");
            entity.Property(e => e.DeconseilleAuxEnfants).HasDefaultValue(false);
            entity.Property(e => e.Description).HasColumnType("text");
            ...
            entity.HasOne(d => d.SpectacleEnfant1).WithMany(p => p.InverseSpectacleEnfant1)
                .HasForeignKey(d => d.SpectacleEnfant1Id)
                .HasConstraintName("FK_Spectacle_SpectacleEnfant1");

            entity.HasOne(d => d.SpectacleEnfant2).WithMany(p => p.InverseSpectacleEnfant2)
                .HasForeignKey(d => d.SpectacleEnfant2Id)
                .HasConstraintName("FK_Spectacle_SpectacleEnfant2");

            entity.HasOne(d => d.SpectacleEnfant3).WithMany(p => p.InverseSpectacleEnfant3)
        ...
        modelBuilder.Entity<TarifsGroupe>(entity =>
        {
            ...
            entity.HasIndex(e => e.GroupeId, "IX_TarifsGroupes_GroupeID");
        ...
        modelBuilder.Entity<TarifsSpectacle>(entity =>
        {
            ...
            entity.HasIndex(e => e.SpectacleId, "IX_TarifsSpectacles_SpectacleID");
